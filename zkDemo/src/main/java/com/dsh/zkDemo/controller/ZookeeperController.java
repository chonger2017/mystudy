package com.dsh.zkDemo.controller;

import com.dsh.zkDemo.impl.ZooKeeperImpl;
...
public class ZookeeperController {
     ...
     * zookeeper 获取节点下的数据
     *
     * post请求： http://localhost:8080/zookeeper/makeOrder?path=/task
     *
     * @param path
     * @return
     */
